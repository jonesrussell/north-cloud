...
func TestClassifySuccess(t *testing.T) {
	...
	client := mlclientv2.NewClient("crime", srv.URL, mlclientv2.WithTimeout(2*time.Second))
...
func TestClassifyTimeout(t *testing.T) {
	...
	client := mlclientv2.NewClient("slow", srv.URL, mlclientv2.WithTimeout(50*time.Millisecond))
...
func TestClassifyCircuitBreaker(t *testing.T) {
	...
	client := mlclientv2.NewClient("test", srv.URL,
		mlclientv2.WithCircuitBreaker(2, 5*time.Second),
		mlclientv2.WithRetry(0, 10*time.Millisecond),
	)
...
func TestHealthSuccess(t *testing.T) {
	...
	srv := newTestServer(t, func(w http.ResponseWriter, _ *http.Request) {
		resp := mlclientv2.HealthResponse{
			Status:        "healthy",
			Module:        "crime",
			Version:       "v1",
			SchemaVersion: "1.0",
	...
	client := mlclientv2.NewClient("crime", srv.URL)
