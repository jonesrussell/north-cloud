...
GO_SERVICES=(ai-observer alert-crawler auth classifier click-tracker crawler index-manager mcp-north-cloud pipeline publisher rfp-ingestor search signal-crawler signal-producer source-manager nc-http-proxy)
