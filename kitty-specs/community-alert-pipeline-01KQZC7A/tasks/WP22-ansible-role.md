...
- at: '2026-05-06T20:51:29Z'
  event: created
  by: spec-kitty.tasks
authoritative_surface: /home/jones/dev/northcloud-ansible/roles/north-cloud/
execution_mode: code_change
mission_id: 01KQZC7A7SJJZ6EKHZ9JW3AZJG
mission_slug: community-alert-pipeline-01KQZC7A
owned_files:
- /home/jones/dev/northcloud-ansible/roles/north-cloud/templates/alert-crawler.timer.j2
- /home/jones/dev/northcloud-ansible/roles/north-cloud/templates/alert-crawler.service.j2
- /home/jones/dev/northcloud-ansible/roles/north-cloud/defaults/main.yml
- /home/jones/dev/northcloud-ansible/roles/north-cloud/tasks/alert-crawler.yml
priority: P1
tags: []
---
...
This is a **cross-repo work package** operating on `/home/jones/dev/northcloud-ansible/`.
...
Cross-repo. The agent must commit changes inside `/home/jones/dev/northcloud-ansible/` (separate git repo). A separate PR is opened against that repo's `main`.
...
**Steps**:
1. Read `/home/jones/dev/northcloud-ansible/roles/north-cloud/templates/signal-crawler.timer.j2` for the canonical pattern.
2. Create `/home/jones/dev/northcloud-ansible/roles/north-cloud/templates/alert-crawler.timer.j2`:
   ```ini
   [Unit]
...
**Files**:
- `/home/jones/dev/northcloud-ansible/roles/north-cloud/templates/alert-crawler.timer.j2` (new, ~12 lines).
...
**Steps**:
1. Read `/home/jones/dev/northcloud-ansible/roles/north-cloud/templates/signal-crawler.service.j2` for the canonical pattern.
2. Create `/home/jones/dev/northcloud-ansible/roles/north-cloud/templates/alert-crawler.service.j2`:
   ```ini
   [Unit]
...
**Files**:
- `/home/jones/dev/northcloud-ansible/roles/north-cloud/templates/alert-crawler.service.j2` (new, ~16 lines).
...
**Steps**:
1. Edit `/home/jones/dev/northcloud-ansible/roles/north-cloud/defaults/main.yml`:
   ```yaml
...
**Files**:
- `/home/jones/dev/northcloud-ansible/roles/north-cloud/defaults/main.yml` (modified, +~10 lines).
- `/home/jones/dev/northcloud-ansible/roles/north-cloud/tasks/alert-crawler.yml` (new, ~50 lines) OR extend `tasks/main.yml`.
...
**Files**:
- `/home/jones/dev/northcloud-ansible/roles/north-cloud/tasks/alert-crawler.yml` (already from T096).
